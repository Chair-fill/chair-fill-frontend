    ...
    try {
      ...
      try {
        const { data } = await api.get<{ url?: string }>(
          `/payment/checkout-session?planId=${plan.id}`,
        );
        if (data?.url) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        ...
        onClick={handleClose}
      />
      <div className="relative bg-[#0a0a0a] rounded-2xl border border-border shadow-xl w-full max-w-md overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="button"
                  onClick={handlePay}
                  className="flex-1 px-4 py-2.5 bg-primary text-primary-foreground rounded-full hover:opacity-90 transition-all font-semibold flex items-center justify-center gap-2"
                >
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2.5 bg-primary text-primary-foreground rounded-full hover:opacity-90 transition-all font-semibold"
                >
                  Try Again
                </button>
              </div>
